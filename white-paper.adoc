...
Tabelle 1. Eigenschaften von Identifikatoren 
	DID	UUID	URN	DigitalLink	DOI
Persistent	[check]	[check]	[check]	[check]	[check]
Global auflösbar	[check]	[times]	[check]	[check]	[check]
Kryptographisch verifizierbar	[check]	[times]	[times]	[times]	[times]
Dezentral	[check]	[check]	[times]	[times]	[times]
