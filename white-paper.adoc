...
Sollten Sie dahingehend bereits ein breites Wissen haben, dürfen Sie
<<Intro>> gerne überspringen. Denn in diesem erhalten Sie einen
Überblick über wichtige theoretische Konzepte für das weitere
Verständnis der Praxisbeispiele und Prototypen, die wir im Laufe des
Projekts entwickelt haben. In den darauf folgenden Abschnitten dieses
Dokuments bieten wir Einblicke in die technische Umsetzung
interessanter Anwendungsfälle innerhalb bestehender IoT-Ökosysteme
unter Verwendung der GS1-Standards.
