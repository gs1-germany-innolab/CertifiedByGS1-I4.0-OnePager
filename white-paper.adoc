...
Auf Empfehlung der in- und externen Projektbeteiligten werden die im Projekt erarbeiteten Konzepte und Demonstrationen zu Prototypen und möglichst auch einem Minimum Viable Product (MVP) weiterentwickelt werden. Sie können uns dabei unterstützen und Teil dieser spannenden Entwicklung sein! Erfahren Sie alles über das Konzept auf den nachfolgenden Seiten und mailto:Certified@gs1.de[kontaktieren Sie uns gerne mit Fragen, Anregungen und Beteiligungswünschen unter Certified@gs1.de.]
...
Soziale und geschäftliche Beziehungen sind in hohem Maße auf Identitätsnachweise angewiesen, um andere Parteien zu identifizieren und zu authentifizieren. Sie tragen dazu bei, die mit verschiedenen Arten von Interaktionen verbundenen Risiken anzugehen und das Vertrauen zwischen den interagierenden Parteien zu stärken.
