...
Zum Beispiel kann Ingo einen nicht direkt von ihm zertifizierten
(d.h. nicht bekannten) öffentlichen Schlüssel von Manuel als
vertrauenswürdig einstufen, wenn z.B. mindestens zwei Personen denen
Alice vertraut, Bobs schlüssel als vertrauenswürdig zertifiziert
haben, siehe <<pic_wot>>. Über die genauen Parameter können Teilnehmer im Web of Trust
...
Vertrauensübertrag über beliebig wenige/lange Pfade dargestellt.
