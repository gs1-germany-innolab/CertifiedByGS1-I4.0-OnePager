...
Die Entwicklung einer solchen dezentralisierten
Public Key Infrastructure (DPKI) ist momentan in vollem Gange und
könnte ebenso große
...
für den verschlüsselten Netzwerkverkehr hatte.
