...
image::Trust-in-classical-id.png[]
...
Identifikationsschlüssel _Certified By GS1_ selbst ausweisen könnten
und damit automatisiert authentifiziert werden können. Das bedeutet,
...
Kunden auf Basis der GCP zertifizierten selbst Identifikationsnummern
in seinem Nummernkreis zu erzeugen.  Das _Certified by GS1_ Konzept,
dass hier vorgestellt wird, sieht vor, dass der Inhaber einer
...
Wie in <<sec_compare>> dargestellt führt gerade diese dezentralistät
des GS1 Systems kombiniert mit einem dezentralen digitalen und
kryptografisch abgesicherten Identifikationsplatform wie SSI zu einem
...
einmaliges System von Identen benötigt, wie es Certified by GS1 durch
...
Im Certified by GS1 Projekt wurde die Zertifizierung der
...
In dem hier vorgestellten Protokoll (siehe <<pic_GS1SSI>>) haben nicht nur die beteiligten
...
Gegenständen eine eigene DID erhältt, etwa alle Sensoren einer bestimmten Baureihe eines
...
Zertifikate, etwa ein Bio Label für Lebensmittel oder Konformitäts
Label für elektronische Geräte, ebensfalls von den Herausgebern der
...
zuweist. Hiermit bestätigt GS1, dass diese Firma in der Tat GS1 Kunde
...
<<pic_GS1SSI>> dargestellt wird die DID der zugehörigen GTIN als
...
Ausstellung von Identifikationsschlüsseln Certified by GS1
...
Denkbar wären viele Varianten von der reiner schriftlicher
...
gar persönlicher Rücksprache mit entsprechend Berechtigten. Diese
