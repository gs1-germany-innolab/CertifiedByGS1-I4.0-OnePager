...
Authentifizierung von natürlichen und juristischen Personen, aber auch von
...
In vielen Anwendungsfällen wir eine weitgehende Automatisierung von Abläufen
...
(Selv Sovreign Identity) Technologie, die sich aktuell rasant entwickelt und
...
erarbeitet. In zusammenarbeit mit den externen Partnern wurden mehrere konkrete
Use Cases ausformuliert, um die Vielzahl von Anwendungsmöglichkeiten des
Konzeptes zu verdeutlicht.
...
=== Industrie 4.0 - Beispiel Microgrids 
==== Problemstellung
