...
Legitimität des Antrags, bzw. des Antragsstellers aktuell nicht überprüft. Dies
ist auch nicht nötig und würde keinen Mehrwert bringen. Um eine Vertrauensbasis
für ein System von Certified by GS1 Identen zu schaffen muss ein
Registrierungsprozess etabliert werden, der die Legitimität des Antrags
überprüft. Im Unterschied zum bestehenden Prozess wir bei Certified nicht nur
ein Nummernkreis einer Firma zugeordnet. Das zur GCP gehörende digitale
Zertifikat etabliert die Zugehörigkeit eines privaten Schlüssels als
Autorisierungsmerkmal zu einer Firma. Vertrauen in das System und die Echtheit
von zertifizierten Identen basiert darauf, dass diese initiale Überprüfung der
Identität der Firma sicher erfolgt. Dann, und nur dann, kann bei nach
erfolgreicher Überprüfung der digitalen Signatur, z.B. einer Certified GTIN, der
Prüfer sicher sein, dass der Identifikationsschlüssel in der Tat legitim von der
Firma erstellt wurde, welcher der Nummernkreis gehört.
