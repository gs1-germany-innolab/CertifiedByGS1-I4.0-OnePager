...
digitale Signaturen und Zertifikate erläutern und darstellen was sie
...
<<sec_implementation>> erläutert die technischeN Umsetzungskonzepte.
...
In diesem Sinne erfüllt GS1 bereits die Rolle einer "Issuing
Agency".  In "Certified by GS1" wurden Konzepte entwickelt, die in
...
[*Satz ist viel zu lang - sinnvolle Trennung in 2 Teile?*]
...
[IMPORTANT]
--
- Publikationen? D.h. man kauft auch Schriftstücke? ;) -> ja, tatsächlich beinhaltet dieses Kaufen eine ganze Bibliothek an Dokumenten, die sonst kostenpflichtig sind. Würde ich so stehen lassen.
--
...
[IMPORTANT]
--
Motivation? -> Erläutern warum die LEI hier detailliert erklärt wird -> im ersten Absatz hinzugefügt
--

GS1 vergibt jedoch nicht nur Idente im Rahmen der eigenen Standards.
...
Das bedeutet, dass GS1 bereits heute authentifizierte Idente vergibt und somit die
Grundlage für das Konzept "Certified by GS1" bereits gelegt ist. Die LEI wird als Konzept für ein 
authentifiziertes GS1 Ident genutzt. Im weiteren Verlauf wird deutlich welche Merkmale der LEI
verhindern sie als ausschließliches Ident für Certified-Zwecke zu nutzen.
...
in dem zugeteilten Nummernkreis eigene Idente zu vergeben. Hier gibt es erneut einen
...
registrieren. GS1 hält global derzeit mehr als 1 Millionen GCPs.
...
Die symmetrischen Verschlüsselungsverfahren reichen weit in die Menschheitsgeschichte zurück. Alle kryptografischen Algorithmen begannen als symmetrische Verfahren.
...
Die Funktionsweise der symmetrischen Schlüssel ist recht einfach. Es gibt nur einen Schlüssel, den geheimen Schlüssel. Der wird für die Ver- wie auch für die Entschlüsselung genutzt. Das bedeutet aber auch, dass sowohl der Sender, als auch der Empfänger immer diesen Schlüssel benötigen. Der Versender hat diesen Schlüssel und muss diesen auch über einen sicheren Übertragungsweg dem Empfänger zugänglich machen, um z.B. ein Mitlesen der verschlüsselten Nachricht nicht zu ermöglichen. 
Eine symmetrische Verschlüsselung kann man für das Verschlüsseln von Dateien, Verzeichnissen oder Laufwerken nutzen. 

==== Asymmetrische Verschlüsselung

In der Praxis nutzt man heute eher die asymmetrische Verschlüsselung.

Denn bei der asymmetrischen Verschlüsselung benötigt man je einen Schlüssel zum Verschlüsseln der Daten und einen anderen Schlüssel zum Entschlüsseln. Der zur Verschlüsselung verwendete Schlüssel wird in einem asymmetrischen Verfahren als öffentlicher Schlüssel bezeichnet und kann jedem frei mitgeteilt werden. Der für die Entschlüsselung verwendete Schlüssel muss hingegen geheim gehalten werden. [*kann man das Wort "Schlüssel" hier auch evtl. das ein oder andere Mal ersetzen?*]
...
GS1 vergibt in gedruckter Form ein Zertifkat für die Teilnahme am globalen GS1 System. In diesem Zertifkat wird unter anderem die GLN und die dazugehörige Firma aufgeführt.
...
Eine PKI lässt sich in mehrere Komponenten einteilen: Eine Registrierungsstelle, eine Zertifizierungsstelle und dem Verzeichnisdienst. 
...
Oftmals befinden sich die Registrierungsstelle und die Zertifizierungsstelle in einem Unternehmen und bilden eine Einheit, als TrustCenter.
...
[* Wie passt dieses Kapitel in die Use Cases? Kann es evtl. rausfallen oder verkürzt werden? Zusammenhang muss geklärt sein*]
...
IDs zu erstellen. Diese grundlegende Idee ist in <<Chain>> dargestellt. [*bereits weiter oben dargestellt*]
...
wie den GS1 Datamatrix kodiert und deren Vertrauenswürdigkeit offline verifiziert
werden.
...
effizienter gestaltet werden können. Die Ressourcen werden gezielt
für den eigentlichen Prozess eingesetzt und der Ressourceneinsatz für
nicht prozessrelevante Vorgänge wird weitestgehend eliminiert. Hierbei
...
können. Über das Microgrid kann die für den Prozess benötigte Leistung
...
beschreiben. Bei Drehstromnetzen wird die Netzfrequenz als primäre Regelgröße genutzt. Wird die zuvor
...
Anlagentypen mehrerer Hersteller unterhalten. Hinzu kommt, dass die Anlagen nach einem Einsatz von z.B. 14
...
[EKU PD Voraussetzungen sehr ausführlich im Vergleich zum Rest erklärt - muss gekürzt werden]
...
[IMPORTANT]
--
In Einleitung verschieben/mergen? [mergen zu gcp und EECC Bsp, sonst komplett raus]
--
