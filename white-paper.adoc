...
Eine interaktive online Demonstration des Use Cases wurde entwickelt, um den in diesem Abschnitt vorgestellten Use Case anschaulich und leicht verständlich darzustellen.  Die Demonstration ist unter <<online-demo>> öffentlich zugänglich.
