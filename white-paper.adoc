...
1976 von Diffie und Hellman in ihrem Aufsatz "New Directions in
...
Adleman stellten 1978 mit RSA das erste asymmetrische
...
Das in <<symm>> erwähnte Problem des Schlüssel austausches wird also
...
man-in-the-middle  Angriffs, der in <<mitm>> erläutert wird.
...
fragt zu diesem zweck bei einem Schlüssel-Verzeichnis-Server Bobs öffentlichen
...
Signatur verwendet, auch wenn diese kozeptionell/juristisch die
Funktion einer Unterschrift erfüllt.

Mit dem öffentlichen Schlüssel kann der Empfänger von Dokument und Signatur
...
Steht die in <<mitm>> erwähnte vertrauenswürdige
